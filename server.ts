...
import { testFirestoreConnection } from './src/server/firestoreStorage';
...
// --- Real Database Connectivity Health Check ---
...
// Restore saved data from Cloud Firestore to Supabase PostgreSQL
